	...
	public static void main(String... args) {
		...
		//for (String errorCode : errorsCode) {
			...
			//String apis = "UserInfo-SUCCESS,UserInfo-ERROR";
			 // String apis = "UpdateServicePermissionFlag-SUCCESS,UpdateServicePermissionFlag-ERROR,ValidateToken-SUCCESS,ValidateToken-ERROR";
		...
		//for (String clientId : clientIdList) {
			//	String clientName = clinetNameMap.get(clientId);
				//report.append(" Client Id," + clientId + ",Client Name," + clientName + ", Error Code ," +errorCode+ "\n");
				//report.append(" Client Id," + clientId + ",Client Name," + clientName  + "\n");
